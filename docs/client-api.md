...
The `unifyfs_stat_global_size()` method obtains the currently known maximum valid offset across all servers. If the file has been laminated, this is the final file size.
